                    ...
                    @if ($iconExists)
                        <x-filament::icon
                            ...
                            @class([
                                'flex-shrink-0',
                                match ($iconSize) {
                                    IconSize::Small, 'sm' => $iconSizeSm ?: 'h-8 w-8',
                                    IconSize::Medium, 'md' => $iconSizeMd ?: 'h-9 w-9',
                                    IconSize::Large, 'lg' => $iconSizeLg ?: 'h-10 w-10',
                                    default => 'h-8 w-8',
                                },
                                match ($color) {
                    ...
                    <div {{ $getExtraOptionsAttributeBag()->merge(['class' =>'place-items-start']) }}>
                        ...
                        @if (!is_null($pricing))
                            <span class="font-medium text-primary-600 mt-3 mb-3">
                                € {{ $pricing }}
                                <span style="font-size: 10px" class="text-gray-500 dark:text-white">/ month</span>
                            </span>
